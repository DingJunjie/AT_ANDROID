...
import com.bitat.ui.common.Title
import com.bitat.ui.theme.AppColor
...
public fun Toast(
    ...
    val colorData = when (toastData.type) {
        ToastModel.Type.Normal -> ColorData(
            backgroundColor = WeComposeTheme.colors.background,
            textColor = WeComposeTheme.colors.textPrimary,
            iconColor = WeComposeTheme.colors.textPrimary,
            icon = Icons.Rounded.Notifications,
        )

        ToastModel.Type.Success -> ColorData(
            backgroundColor = WeComposeTheme.colors.success,
            textColor = WeComposeTheme.colors.textPrimary,
            iconColor = WeComposeTheme.colors.textPrimary,
        ...
        ToastModel.Type.Info -> ColorData(
            backgroundColor = WeComposeTheme.colors.info,
            textColor = WeComposeTheme.colors.textPrimary,
            iconColor = WeComposeTheme.colors.textPrimary,
        ...
        ToastModel.Type.Error -> ColorData(
            backgroundColor = WeComposeTheme.colors.error,
            textColor = WeComposeTheme.colors.textPrimary,
            iconColor = WeComposeTheme.colors.textPrimary,
            icon = Icons.Rounded.Warning
        )
            ...
            backgroundColor = WeComposeTheme.colors.dialogBackground,
            textColor = WeComposeTheme.colors.textPrimary,
            iconColor = WeComposeTheme.colors.textPrimary,
            icon = Icons.Rounded.Notifications,
        )
